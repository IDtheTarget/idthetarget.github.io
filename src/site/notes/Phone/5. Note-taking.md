---
{"dg-publish":true,"permalink":"/phone/5-note-taking/","updated":"2025-11-16T12:56:44.870-06:00"}
---
...
# Synchronization
Because my laptop is my primary note-taking platform (I touch-type on the laptop much faster than I can thumb-type on my phone), I [[Laptop/5. Note-taking#Synchronizing\|already sync'd my notes from the laptop to the Pi]]. Now I need to get them from the Pi to the phone. So, we actually start on the Pi.
...
- Under the "Unshared Devices", find the phone you just added in [[Phone/4. Syncthing\|Phone/4. Syncthing]].
...
- Click the check mark to save.
 ...
 Previous: [[Phone/4. Syncthing\|Phone/4. Syncthing]]
 Next: [[Phone/6. Nextcloud\|Phone/6. Nextcloud]]