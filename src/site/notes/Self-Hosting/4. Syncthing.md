---
{"dg-publish":true,"permalink":"/self-hosting/4-syncthing/","updated":"2025-11-16T12:57:01.849-06:00"}
---
...
Please note that this page is only for the initial set-up of Syncthing on the Raspberry Pi. See also the initial set-ups for my [[Laptop/4. Syncthing\|Laptop]] and [[Phone/4. Syncthing\|Phone]]. I cover the steps to share individual folders in their respective sections, i.e. [[Self-Hosting/5. Note-taking\|Self-hosting/4. Note-taking]] and [[Laptop/5. Note-taking\|Laptop/4. Note-taking]].
...
You're now ready to set up [[Self-Hosting/5. Note-taking#Synchronizing\|synchronizing Obsidian]] with the [[Laptop/5. Note-taking#Synchronizing\|Laptop]]

Previous: [[Self-Hosting/2. Raspberry Pi Initial Configuration\|2. Raspberry Pi Initial Configuration]]
Next: [[Self-Hosting/5. Note-taking\|5. Note-taking]]